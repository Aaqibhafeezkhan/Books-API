...
public class OpenLibraryService {
    ...
    @Cacheable(
            cacheNames = "bookSearches",
            key = "new org.springframework.cache.interceptor.SimpleKey(#request.query, #request.filterType, #request.filterValue, #request.page, #request.size)")
